...
\setAuthor{\authorTitleBefore\authorSurname \authorName\authorTitleAfter}
\setAuthorId{MATRIKELNUMMER}
\setStudyprogram{Master's in Mechatronics}
\setSupervisor{\supervisorTitleBefore\supervisorSurname \supervisorName\supervisorTitleAfter}
